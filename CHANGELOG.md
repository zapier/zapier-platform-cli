...
* (improvement) `zapier convert` properly escapes labels and descriptions ([PR](https://github.com/zapier/zapier-platform-cli/pull/233))
...
* (improvement) Don't require an `id` field in scaffolded tests ([PR](https://github.com/zapier/zapier-platform-cli/pull/243/files))
