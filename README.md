...
All Zapier CLI apps are run using Node.js `4.3.2`.

You can develop using any version of Node you'd like, but your code has to run on Node `4.3.2`. You can accomplish this by developing on your preferred version and then transpiling with [Babel](https://babeljs.io/) (or similar).

To ensure stability for our users, we also require that you run your tests on `4.3.2` as well. If you don't have it available, we recommend using either [nvm](https://github.com/creationix/nvm#installation) or [n](https://github.com/tj/n#installation) to install `4.3.2` and run the tests locally.
